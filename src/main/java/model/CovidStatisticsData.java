...
public class CovidStatisticsData {
    ...
    public CovidStatisticsData(int id, double total_cases, double new_cases, double new_cases_smoothed, double total_deaths, double new_deaths, double new_deaths_smoothed, double reproduction_rate, double new_tests, double total_tests) {
        this.id = id;
